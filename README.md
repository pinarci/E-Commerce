...
Step 2: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```https://github.com/pinarci/shopping-cart.git```> Select master Branch > Next > Next > Finish.
