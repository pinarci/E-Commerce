...
public class MailMessage {
	public static void registrationSuccess(String emailId, String name) {
		...
		String htmlTextMessage = "" + "<html>" + "<body>"
				+ "<h2 style='color:green;'>Welcome to 232 Electronics</h2>" + "" + "Hi " + name + ","
				+ "<br><br>Thanks for singing up with 232 Electronics.<br>"
				...
				+ "branded items.<br><br>As a Welcome gift for our New Customers we are providing additional 10% OFF Upto 500 TL for the first product purchase. "
				+ "<br>To avail this offer you only have "
				+ "to enter the promo code given below.<br><br><br> PROMO CODE: " + "232500<br><br><br>"
	...
	public static void transactionSuccess(String recipientEmail, String name, String transId, double transAmount) {
		...
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with 232 Electronics!" + "      <br/><br/>"
				...
				+ "      Come Shop Again! <br/<br/> <font style=\"color:green;font-weight:bold;\">232 Electronics.</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
