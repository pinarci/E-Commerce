...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "232@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to 232 Electronics</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with 232 Electronics.<br>"
					...
					+ "branded items. As a Welcome gift for our New Customers we are providing additional 10% OFF Upto 500 TL for the first product purchase. To avail this offer you only have "
					+ "to enter the promo code given below.<br><br> PROMO CODE: "
					+ "<span class='greenText'>232500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
