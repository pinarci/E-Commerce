...
import com.db.beans.CartBean;
import com.db.beans.OrderBean;
import com.db.beans.OrderDetails;
import com.db.beans.TransactionBean;
import com.db.service.OrderService;
import com.db.utility.DBUtil;
	...
	public String paymentSuccess(String userName, double paidAmount) {
		...
		if (ordered) {
			...
			if (ordered) {
				...
				status = "Güzel günlerde kullanın!";
			}
		}
